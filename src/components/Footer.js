  ...
  return (
    <div className="footer__div">
        ...
        <div className="col-sm-12 col-md-8 footer__div-left">
  				<span className="footer_regular">A sua opinião é importante. Partilhe-a!</span>
  				<br/>
  				<span className="footer_light">Contactos: 249 391 018 // 918 628 963</span>
  			</div>

  			<div className="col-sm-12 col-md-4 footer__div-right">
  				<div className="footer_div floating_margin_left">
  					<div className="float-left">
  						<span className="footer_regular">Siga-nos</span><br/>
                ...
                <img className="footer_img" src="/public/images/footer/footer_insta.png" height="35px" />
  				...
  				<div className="floating_margin_left mt20">
  					<span className="footer_copyright">Todos os direitos reservados a Explazeite &#9400; 2017</span>
  				</div>
  			</div>
