...
const items = [
  {
    src: '/public/images/destaques/apanha1.png',
    altText: '',
    caption: ''
  },
  {
    src: '/public/images/destaques/apanha2.png',
    altText: '',
    caption: ''
  },
  {
    src: '/public/images/destaques/apanha3.png',
    altText: '',
    caption: ''
  },
];
      ...
      <Row>
        <Col xs="12" sm="12" md="12">
          <div className="no-padding">
            <h1><FormattedMessage id="featured.item4.label" /></h1>
            <h3>//</h3>
            <br/>
          </div>
        </Col>
        ...
        <Col xs="12" sm="12" md="12">
          <div className="featured-item__description">
            <h2 className="subheader">
              <FormattedMessage id="featured.item4.subtitle" />
            </h2>
            <p><FormattedMessage id="featured.item4.p1" /></p>
            <p><FormattedMessage id="featured.item4.p2" /></p>
            <p><FormattedMessage id="featured.item4.p3" /></p>
          </div>
        </Col>
      </Row>
    </div>
