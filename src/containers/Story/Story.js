    ...
    <div className="center-container">
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-6 float-left no-padding">
              <img className="history-img" src="/images/historia/crono_1.png" alt="" />
            </div>
            <div className="col-md-6 float-right no-padding">
              <img className="history-img" src="/images/historia/crono_2.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-12 no-padding">
              <img className="history-img" src="/images/historia/crono_3.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-6 float-left no-padding">
              <img className="history-img" src="/images/historia/crono_4.png" alt="" />
            </div>
            <div className="col-md-6 float-right no-padding">
              <img className="history-img" src="/images/historia/crono_5.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-12 no-padding">
              <img className="history-img" src="/images/historia/crono_6.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-12 no-padding">
              <img className="history-img" src="/images/historia/crono_7.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-12 no-padding">
              <img className="history-img" src="/images/historia/crono_8.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-12 no-padding">
              <img className="history-img" src="/images/historia/crono_9.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-12 no-padding">
              <img className="history-img" src="/images/historia/crono_10.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
        <VerticalTimelineElement
        ...
        >
          ...
          <div className="history-img-div">
            <div className="col-md-12 no-padding">
              <img className="history-img" src="/images/historia/crono_11.png" alt="" />
            </div>
          </div>
        </VerticalTimelineElement>
      </VerticalTimeline>
